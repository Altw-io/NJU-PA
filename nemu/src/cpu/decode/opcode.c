...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea_m2r_v,  mov_rm2r_w, inv,
    ...
    /* 0xe8 - 0xeb*/ call_direct, jmp_i_near, jmp_ptr, jmp_i_short_,
...
instr_func group_1_b_entry[8] =
    {inv, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, and_i2rm_b, inv, xor_i2rm_b, cmp_i2rm_b};
...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, not_rm_b, neg_rm_b, mul_rm2a_b, inv, inv, inv};
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_indirect, inv, jmp_rm_v, inv, push_rm_v, inv};
